import 'package:agendamentos_app/data/models/dao/promotoria_dao.dart';
import 'package:agendamentos_app/data/models/dao/usuario_dao.dart';
import 'package:agendamentos_app/data/models/promotoria.dart';
import 'package:agendamentos_app/data/models/usuario.dart';
import 'package:agendamentos_app/utils/helpers/validators.dart';
...
class UsuarioEditor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    late Usuario user = Usuario(
        id: usuarioValor?.id, nome: nome.text, email: email.text, senha: '***');
                    ...
                    builder: (context, snapshots) {
                      ...
                      if (!snapshots.hasData) {
                        ...
                        for (var promotoria in promotorias!) {
                          promotoriaItens.add(DropdownMenuItem(
