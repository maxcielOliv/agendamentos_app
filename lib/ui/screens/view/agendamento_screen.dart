import 'package:agendamentos_app/data/models/agendamento.dart';
import 'package:agendamentos_app/data/models/dao/agendamento_dao.dart';
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      Text(
                        'Missão: ${agendamento.local.toString()}',
