import 'package:agendamentos_app/data/models/dao/veiculo_dao.dart';
import 'package:agendamentos_app/ui/screens/calendar/agendamento_editor.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListTile(
                            ...
                            subtitle: Text(
                                veiculo.motorista.toString().toUpperCase()),
                            trailing: AuthService().adminEnabled ||
                                    AuthService().agendEnabled
                                ? IconButton(
